...
<head>
  ...
  <style>
    ...
    .container {
      ...
      padding: 20px;
      background-color: #fff;
      box-shadow: 0 0 10px rgb(175 189 248);
  ...
  <div class="container">
    ...
    try {
      ...
      $SEM = $_GET['sem'];
       ...
       $sql = "select * from pg_marksheet where rollno='$roll' and regdno='$reg' and sem='$SEM' ";
    //   $sql = "select * from pg_marksheet where rollno='PG22ECO014' ";
    ...
    <table>
      ...
      <td> <img class="qr-code" src="<?php echo $QrPath; ?>" alt=""> scan me 😇</td>
    </table>
    ...
    <div class="contentsofcontroller"> <p id="small">This is system generated marksheet so signature not required </p>
      <p>Controller of Examinations</p></div>
