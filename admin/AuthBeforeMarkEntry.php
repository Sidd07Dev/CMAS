...
<body>
    ...
    <div class="main">
        <div class="Form-Container">
            <div class="Form-main">
                 <form action="AuthBeforeMarkEntry1.php" method="post">
                    <?php
                   ...
                   <?php
                     echo '<input type="text" name="PAPER" value="' .$PAPER. '" style="display:none">';
                     ?>
                    ...
                    <input type="button" value="back" onclick="window.location.href='insert.php'" class="submit-btn">
