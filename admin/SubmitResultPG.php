...
<body>
        ...
        if ($type == 'midSem') {
            ...
            while ($i < $counter) {
                ...
                if (!$con) {
                    ...
                    $query = "update pm1dtdb2 set CMRK='$midSem' where ROLLNO='$RollNo' and SUB='$paper'";
            ...
            while ($j < $counter) {
                ...
                if (!$con) {
                    ...
                    $query1 = "update pm1dtdb2 set EMRK='$endSem' where CODE='$Code' and SUB='$paper'";
            ...
            while ($i < $counter) {
                ...
                if (!$con) {
                    ...
                    $query = "update pm1dtdb2 set PRMRK='$practical' where ROLLNO='$RollNo' and SUB='$paper'";
                    // $query="update pm1dtdb set MID_SEM='$midSem',PRACTICAL='$practical',END_SEM='$endSem' where ROLLNO='$RollNo' and SUB='$paper'";
                    $result = $con->query($query);
                    if ($result == true) {
        ...
        if ($type == 'midSem') {
            ...
            while ($i < $counter) {
                ...
                if (!$con) {
                    ...
                    $query = "update pm1dtdb2 set CMRK='$midSem',STATUS_MID='$checkMid' where ROLLNO='$RollNo' and SUB='$paper'";
                    // $query="update pm1dtdb set MID_SEM='$midSem',PRACTICAL='$practical',END_SEM='$endSem' where ROLLNO='$RollNo' and SUB='$paper'";
                    $result = $con->query($query);
                    if ($result == true) {
            ...
            while ($j < $counter) {
                ...
                if (!$con) {
                    ...
                    // $query="update pm1dtdb set MID_SEM='$midSem',PRACTICAL='$practical' where ROLLNO='$RollNo' and SUB='$paper'";
                    $query1 = "update pm1dtdb2 set EMRK='$endSem',STATUS_END='$checkEnd' where CODE='$Code' and SUB='$paper'";
                    $result1 = $con->query($query1);
                    if ($result1 == true) {
            ...
            while ($i < $counter) {
                ...
                if (!$con) {
                    ...
                    $query = "update pm1dtdb2 set PRMRK='$practical',STATUS_PRACTICAL='$checkPract' where ROLLNO='$RollNo' and SUB='$paper'";
                    // $query="update pm1dtdb set MID_SEM='$midSem',PRACTICAL='$practical',END_SEM='$endSem' where ROLLNO='$RollNo' and SUB='$paper'";
                    $result = $con->query($query);
                    if ($result == true) {
    ...
    echo '<a href="insert2.php">click here</a>';
    ?>
</body>
