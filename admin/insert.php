...
<head>
    ...
    <title>CMAS-Add-Result-UG</title>
...
<body>
    ...
    <div class="main">
        <div class="Form-Container">
            <div class="Form-main">
                <form action="AuthBeforeMarkEntry.php" method="post">
                    <div class="col-md-4">
                        <h3>Mark Insert For UG Only</h3>
                    </div>
                    <div class="col-md-4">
                        <label for="sem">Semester:-</label>
                        <select name="sem" id="sem" class="form-control"></select>
                    </div>
                    <div class="col-md-4">
                        <label for="country">Hons:-</label>
                        <select type="text" name="country" id="country" class="form-control">
                             <option value="">Select Hons</option>
                        </select>
                    </div>
                    <div class="col-md-4">
