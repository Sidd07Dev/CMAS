...
<head>
    ...
    <title>CMAS-InsertResults</title>
...
?>
    ...
    <div class="main">
        <div class="Form-Container">
            <div class="Form-main">
                <form action="SubmitResultUG.php" method="post" style="font-weight:bold">
                    ...
                    $query = "select * from pm1dtdb1 where  SUB='$paper'";
                    ...
                    <table border="0" cellspacing="5px">
                        ...
                        if ($TYPE == "midSem") {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                if ($row['STATUS_MID'] == 1) {
                                    ...
                                    echo '<td><input type="text"  name="RollNo" value="' . $row['ROLLNO'] . '" required="required" readonly> </td>';
                                    echo '<td><input type="text"   name="MID" value="' . $row['CMRK'] . '"  required="required" readonly></td></tr>';
                                } else {
                                    
                                    echo '<td><input type="text"  name="RollNo' . $i . '" value="' . $row['ROLLNO'] . '" required="required" readonly> </td>';
                        ...
                        if ($TYPE == "endSem") {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo '<tr> <td>'.$j.'</td>';
                                if ($row['STATUS_END'] == 1) {
                                    echo '<td><input type="text"  name="Code" value="' . $row['CODE'] . '" required="required" readonly> </td>';
                                    echo '<td><input type="text"  name="END" value="' . $row['EMRK'] . '"  required="required" readonly> </td></tr>';
                                } else {
                                    echo '<td><input type="text"  name="Code' . $i . '" value="' . $row['CODE'] . '" required="required" readonly> </td>';
                    ...
                    <input type="button" value="back" onclick="window.location.href='insert.php'" class="sub-btn">
                </form>
